...
export const WORKSHEETS: Worksheet[] = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        example: "「社長の“右腕AI”を作ってる人がいてさ」と言ってもらえると話が早い。",
      },
      {
        id: "ws01_06",
        num: "06",
      ...
      },
      {
        ...
        label: "まとめ（1文で）",
        hint: "紹介される時の一言 ＝",
        example: "「忘れてる売上を掘り起こす“右腕AI”を作っている人」",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        example: "判断軸を覚える → 自分が動かなくても“自分らしい”対応ができる。",
      },
      {
        id: "ws02_04",
        num: "04",
        ...
        example: "単なるAIでなく“あなたの考えを移植する”。人間理解が土台。",
      },
      {
        id: "ws02_05",
        num: "05",
        ...
        example: "Mission: 経営者を孤独から解放する／Value: 関係性・長期・誠実。",
      },
      {
        id: "ws02_06",
        num: "06",
        ...
        example: "データは本人のもの。勝手に送らない（送信は本人承認）。",
      },
      {
        id: "ws02_07",
        num: "07",
        ...
        example: "紹介の専門家が作ったAIだから、人脈の活かし方に強い。",
      },
    ],
  },
  {
