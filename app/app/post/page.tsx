      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-xs text-gray-400 mb-2">
                  スコアではなくストーリーで伝えましょう。どんな場面で、なぜ心に残ったのかを書いてみてください。
                </p>
                <textarea
                  id="story"
                  required
                  rows={5}
                  placeholder="例: 大切な商談の前日に訪れた一軒。大将の丁寧な仕事に心が落ち着き、翌日の商談は見事に成功。以来、勝負の前夜はここと決めています。"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
            <Link
              href="/app/dashboard"
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl border-2 border-gray-200 text-gray-600 font-medium hover:bg-gray-50 transition-colors"
            >
              キャンセル
            </Link>
            <button
