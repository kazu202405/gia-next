...
// 入会申請管理ページ（mock）。
// /admin 配下に移動 — 旧パス: /members/app/admin（一般ユーザー向けアプリと混在していたものを分離）。
// Phase 1: 認証ガード未実装。URL 直打ちで誰でも到達可能。
// TODO: Phase 2 で Supabase Auth + admin role 判定によるガードを入れる。
//
// レイアウト枠（上部ヘッダー / 左サイドナビ）は app/admin/layout.tsx 側で持つ。
// ここではセクションヘッダー（入会申請 + pending バッジ）と本体のみ。
...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)]">
      {/* セクションヘッダー（layout 側のブランドヘッダーとは別レイヤー） */}
