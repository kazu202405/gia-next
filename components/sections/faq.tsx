...
const faqs = [
  {
    question: "「社長の左腕」って、どういう意味ですか？",
    answer:
      "右腕が実行や現場を回す存在だとすれば、左腕は思考を整理し、価値を言語化し、方向性を設計する存在です。私たちは社長の左腕として、属人的な業務を仕組み化し、人にしかできない価値を最大化するお手伝いをしています。",
  },
  {
  ...
  {
    question: "人にしかできないことに本当に集中できるようになりますか？",
    answer:
      "業務内容によりますが、属人的な業務を仕組み化することで「残業ゼロ」「社長不在でも運営可能」を実現した事例があります。段階的に仕組みを整えて、少しずつ本来の価値づくりに集中できる状態をつくります。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "可能ですが、GIAの強みは「仕組み設計から実装まで一気通貫」で対応できる点にあります。仕様が決まっているアプリ開発だけでもお受けしますが、業務フローや紹介・営業の流れから一緒に整理した方が、現場で使われ続けるアプリになりやすいです。まずはご相談ください。",
  },
  {
