...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "GIAは心理整理だけで終わらず、コンサルだけでも終わりません。経営者の感情を理解した上で、それを合理的な構造へ翻訳します。判断基準の設計→KPI→業務動線→システム実装まで一気通貫で対応できるのが最大の違いです。感情と合理の両方を扱えるパートナーは、ほぼ存在しません。",
  },
  {
    question: "無料相談では何がわかりますか？",
    answer:
      "御社の意思決定と業務フローのボトルネックを可視化します。「感覚に頼っている判断はどこか」「何から構造化すべきか」が明確になります。",
  },
  {
