...
const faqs = [
  {
    ...
    answer:
      "もちろんです。AIホットラインは「AIに詳しい人」ではなく「AIをどう使えばいいかわからない人」のための窓口です。専門用語は使わず、御社の業務に合わせてわかりやすくご説明します。",
  },
  {
  ...
  {
    question: "AIツールの導入だけお願いできますか？",
    answer:
      "ツール導入だけのご依頼も可能ですが、まず業務フローを整理することをおすすめしています。整理せずにツールだけ入れても、使われなくなるケースが非常に多いためです。",
  },
  {
