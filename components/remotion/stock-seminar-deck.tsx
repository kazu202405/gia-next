 ...
 *
 * 正本: public/decks/stock-seminar/stock_seminar_full_visual.html
...
// 3:3 5:8 8:2 11:5 15:2 16:3 17:2 18:6 19:2 20:4 21:2 22:2 23:7 27:7 28:7
// 33:3 34:3 36:3 38:4 39:2 41:4 42:2 43:1 45:3 46:2 ＝ 計89段階（全49枚）
export const FRAGMENT_COUNTS = [
  0, 0, 3, 0, 8, 0, 0, 2, 0, 0, 5, 0, 0, 0, 2, 3, 2, 6, 2, 4, 2, 2, 7, 0, 0, 0,
  7, 7, 0, 0, 0, 0, 3, 3, 0, 3, 0, 4, 2, 0, 4, 2, 1, 0, 3, 2, 0, 0, 0,
];
      ...
      <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
        ...
        >
          <iframe
            ref={iframeRef}
            onLoad={onLoad}
            src={staticFile("decks/stock-seminar/stock_seminar_full_visual.html")}
            width={DECK_W}
            height={DECK_H}
...
// 全49枚の通し版（無音）。49×4秒 + fragment88個×1.4秒 ＝ 約5分20秒
