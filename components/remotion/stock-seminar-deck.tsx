...
// 3:3 5:8 7:2 9:13 10:3 11:3 12:7 13:2 14:2 15:4 16:3 17:2 18:2 19:3 20:9
// 23:7 25:3 27:4 28:2 30:4 31:2 32:1 34:3 35:2 ＝ 計94段階（全38枚）
export const FRAGMENT_COUNTS = [
  0, 0, 3, 0, 8, 0, 2, 0, 13, 3, 3, 7, 2, 2, 4, 3, 2, 2, 3, 9, 0, 0, 7, 0, 3, 0,
  4, 2, 0, 4, 2, 1, 0, 3, 2, 0, 0, 0,
];
...
// 全38枚の通し版（無音）。38×4秒 + fragment94個×1.4秒 ＝ 約4分45秒
