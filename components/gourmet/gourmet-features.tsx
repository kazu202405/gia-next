...
const features = [
  {
    ...
    title: "紹介ツリー",
    description:
      "誰が誰を紹介したかが可視化される信頼の連鎖。お店の情報源をたどれるから、安心して選べます。",
  },
  {
    icon: MessageSquare,
    title: "ストーリー型投稿",
    description:
      "スコアや点数ではなく、「なぜこのお店が好きか」をストーリーとして共有。読むだけでワクワクする。",
  },
  {
    icon: Tag,
    title: "コンテキストタグ",
    description:
      "「接待向き」「商談向き」「一人で考え事したい時」など、ビジネスシーンに合わせたタグでお店を探せます。",
  },
  {
    icon: Sparkles,
    title: "AIレコメンド",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="features-header text-center mb-16">
          ...
          <p className="text-lg text-slate-500 leading-relaxed max-w-2xl mx-auto">
            グルメサークルならではの機能が、新しいお店との出会い方を実現します。
          </p>
        </div>
