...
const problems = [
  {
    ...
    title: "星の数に惑わされる",
    description:
      "評価スコアは便利だけど、本当にあなたに合うお店かどうかはわからない。数字だけでは伝わらない「相性」がある。",
  },
  {
    icon: Eye,
    title: "誰が書いたかわからない",
    description:
      "匿名レビューは参考になるようで、実は信頼しにくい。書いた人の好みも背景も見えないから。",
  },
  {
    icon: Megaphone,
    title: "広告で上がってくるお店",
    description:
      "検索上位に表示されるのは、本当に良いお店？それとも広告費をかけたお店？その区別がつきにくい。",
  },
];
